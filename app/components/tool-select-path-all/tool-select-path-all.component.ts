...
@Component({
  selector: 'dcf-tool-select-path-all',
  templateUrl: './tool-select-path-all.component.html',
  styleUrls: ['./tool-select-path-all.component.css'],
  providers: [ ComponentSubscriptionManager ]
})
export class ToolSelectPathAllComponent implements OnInit {
